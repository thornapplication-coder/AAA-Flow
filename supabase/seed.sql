...
insert into pcc.changelog (version, released_on, notes_de, notes_en) values
  ('1.0.0', date '2026-09-19',
   'Erstfreigabe für den Einsatz im Team: Projekte und Teilprojekte, Aufgaben und Teilaufgaben, Gantt mit Abhängigkeiten, Risiken, Berichtslinie zur Geschäftsführung, Ausgaben als PDF und Excel, Verwaltung.',
   'First release for team use: projects and workstreams, tasks and subtasks, Gantt with dependencies, risks, reporting line to management, PDF and Excel output, administration.')
